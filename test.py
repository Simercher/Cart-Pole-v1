...
def main():
    ...
    ## discrete actions
    n_actions = env.action_space.n # left and right
    ...
    for i_episode in range(N_EPISODES):
        ...
        for t in range(EPISODE_LENGTH):
            ...
            # print(q_table)
            observation, reward, done, _, info = env.step(action) # do the action, get the reward
            rewards += reward
    ...
    plot_lr(all_lr, N_EPISODES, 'Q-table')
